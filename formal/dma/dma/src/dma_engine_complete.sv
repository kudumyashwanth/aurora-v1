    ...
    if (!rst_n) begin
        ...
        if (s_axil_awvalid && s_axil_wvalid) begin
            case (wr_addr)
                ...
                REG_INT_STATUS: int_status_reg <= int_status_reg & ~s_axil_wdata;  // W1C
            endcase
        end
    end
end
...
logic [7:0] burst_len;
assign burst_len = (bytes_remaining > 256) ? 8'd15 : ((bytes_remaining >> 4) - 1);
...
assign m_axi_wlast = (fifo_rd_ptr == burst_len);
