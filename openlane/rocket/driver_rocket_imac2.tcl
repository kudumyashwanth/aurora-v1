# imac2: DRC SHOT for RV64IMAC @33MHz. imac33 is functionally signed off (route0/timing-MET/LVS clean)
...
# (macro_placement_imac2.cfg). Reuse imac1 netlist + 30ns SDC (timing already proven). GOAL: route0 /
# LVS unique / mcsta WNS>=0 / DRC <<9504. If extraction breaks (0 rc segs) or LVS mismatches -> imac33 keeps.
package require openlane
prep -design /home/yashwanth/aurora_v1/openlane/rocket/rocket_tile -tag imac2 -overwrite
...
set ::env(CORE_AREA) "20 20 3480 3480"
set ::env(MACRO_PLACEMENT_CFG) /home/yashwanth/aurora_v1/openlane/rocket/rocket_tile/macro_placement_imac2.cfg
